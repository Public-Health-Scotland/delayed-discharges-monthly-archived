#Validation script for Monthly delayed discharges file creation for Highland Region only
#Looks at transfers within hospital and from hospital
...
filepath2<-("/conf/delayed_discharges/RAP development/2019_07/Data/highland/")
...
# #Outofareacaseindicator for any non Highland or Argyll & Bute la codes ( 18 and 4 )
# datafile<-datafile%>% mutate(out_of_area_case_indicator=
#                                if_else(nhs_board=="NHS Highland" &
# local_authority_code %!in%c("4","18"), "Y", " "))
